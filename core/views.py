...
from .forms import NewsletterForm, SeriesCreateForm, ArticleCreateForm, SeriesUpdateForm, ArticleUpdateForm
...
def new_series(request):
    ...
    return render(
        request=request,
        template_name='core/html/new_record.html',
        context={
            "object": "Series",
            "form": form
            }
...
def series_delete(request, series):
    ...
    if request.method == "POST":
        ...
        return render(
            request=request,
            template_name='core/html/confirm_delete.html',
            context={
